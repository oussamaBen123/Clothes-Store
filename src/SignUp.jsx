...
export default function SignUp({toLoginPage}){

   return(
      <div className="w-full h-[calc(100vh-80px)] flex justify-center items-center">
         <div className="flex justify-center items-center flex-col w-[30%]">
            <div className="flex justify-center items-center gap-2.5">
               <h1 className="font-prata text-[35px] font-light">Sign Up</h1>
            ...
            <form onSubmit={(e)=>{e.preventDefault()}} className="flex flex-col justify-center items-center w-full gap-2 !pt-9 !pb-8">
               <input placeholder="Name" className="border-[1px] border-black w-full !py-[7px] !pl-[10px] " type="text" />
               ...
               <button className=" cursor-pointer bg-black !px-8 text-white font-300 !py-2">Sign Up</button>
            </form>
         </div>
      </div>
   )
